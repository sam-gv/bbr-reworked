...
include("js/game/Projectile.js");
include("js/game/AttackArc.js");
	...
	update: function(framerate, area){
        ...
        if(this.attacking){
        	...
        	if(this.animationAttacking >= this.weapons[this.equippedWeapon].attackSpeed * 100){
               ...
               this.animationAttackingIndex=0;
               this.attacking = false;
               //add projectile to list to be rendered.
               //
              	area.addProjectile(new AttackArc(this.x+this.width/2, this.y, this.currentDirection, this));
				//var derp = new AttackArc(this.x+this.width/2, this.y, this.currentDirection, this);
				//console.log(derp);					
					console.log(this);                
                console.log(area);
